...
export default function RoomForm() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await axios.post(`${ENV_File.backendURL}/admin/create`, {
        ...data,
        dateTime,
      });
  ...
  return (
    <div
      className="min-h-screen flex justify-center items-center px-4 py-8 relative"
      style={{
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-2xl p-6 rounded-lg bg-black/50 backdrop-blur-3xl text-white shadow-lg">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-3 rounded-lg bg-gray-500/20 border border-gray-700 focus:outline-none focus:ring-2 focus:ring-yellow-400 placeholder:text-gray-400"
            />
            {errors.roomId && (
          ...
          <div>
            ...
            <select
              ...
              className="w-full p-3 rounded-lg bg-gray-500/20 border border-gray-700 text-white"
            >
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full p-3 rounded-lg bg-gray-500/20 border border-gray-700 text-white placeholder:text-gray-400"
              rows={3}
